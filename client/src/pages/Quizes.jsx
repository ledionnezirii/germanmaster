            ...
            return (
              ...
              >
                ...
                <div className="p-3">
                  <div className="mb-3">
                    <h3
                      className={`text-sm font-bold mb-1.5 line-clamp-2 leading-snug ${
                        isCompleted ? "text-orange-800" : "text-gray-800 group-hover:text-orange-700"
                      }`}
                    >
                      {quiz.title}
                    </h3>
                    <p className={`text-xs font-medium ${isCompleted ? "text-orange-600" : "text-gray-500"}`}>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1 text-xs font-bold px-2 py-1 rounded-lg bg-orange-100 text-orange-700">
                        <Star className="w-3 h-3" />
                        {quiz.xp}
                      </div>
                    </div>
                    ...
                    <button
                      className={`w-full py-2 px-3 rounded-lg text-xs font-bold transition-all duration-200 cursor-pointer ${
                        isCompleted
                          ? "bg-gradient-to-r from-green-600 to-green-600 text-white hover:from-green-700 hover:to-green-700 shadow-sm hover:shadow-md"

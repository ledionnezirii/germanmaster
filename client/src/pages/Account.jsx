...
const Account = () => {
  ...
  return (
    <>
      <SEO 
        title="Llogaria Ime - Gjuha Gjermane"
        description="Shikoni profilin tuaj, arritjet, certifikatat dhe statistikat tuaja të mësimit të gjuhës gjermane."
        keywords="llogaria ime, profil, arritjet, certifikatat, gjuha gjermane, mësimi gjermanishtes"
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-200 p-6">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <div className="mt-4 flex items-center justify-center md:justify-start gap-3 flex-wrap"></div>
            </div>

...
const WELCOME_MSG = {
  de: "Mirë se vini! Do t'ju bëj pyetje për të praktikuar gjermanishten. Le të fillojmë!",
  en: "Mirë se vini! Do t'ju bëj pyetje për të praktikuar anglishten. Le të fillojmë!",
  fr: "Mirë se vini! Do t'ju bëj pyetje për të praktikuar frëngjishten. Le të fillojmë!",
  tr: "Mirë se vini! Do t'ju bëj pyetje për të praktikuar turqishten. Le të fillojmë!",
  it: "Mirë se vini! Do t'ju bëj pyetje për të praktikuar italianen. Le të fillojmë!",
}
    ...
    setMessages([
      {
        id: Date.now(),
        type: "bot",
        content: WELCOME_MSG[language] || WELCOME_MSG.de,
        timestamp: new Date(),
      },
    ])
    setAskedQuestionIds([])
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="bg-white border-b border-gray-200 px-3 py-2 flex items-center justify-between sticky top-0 z-10">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-lg overflow-hidden flex-shrink-0">
              <img
                src={LANGUAGE_FLAGS[language] || LANGUAGE_FLAGS.de}
                alt={language}
        ...
        <div className="border-t border-gray-200 bg-white">
          <div className="px-3 py-2">
            {/* German chars toggle — only for German */}
            {language === "de" && <div className="mb-1.5">
              <button
